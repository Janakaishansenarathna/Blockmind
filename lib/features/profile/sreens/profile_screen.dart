                              ...
                              children: [
                                  ...
                                  children: [
                                    Expanded(
                                      child: _buildStatColumn(
                                        'Today\'s Usage',
                                        profileController.totalUsageTime.value,
                                        Colors.blue,
                                      ),
                                    ),
                                    Container(
                                ...
                                Row(
                                  ...
                                  children: [
                                    _buildMiniStat(
                                      'Apps Used',
                                      profileController.totalAppsUsed.value
                                          .toString(),
                                      Icons.apps,
                                    ),
                                    _buildMiniStat(
                                      'Pickups',
                                      profileController.screenPickups.value
                                          .toString(),
                                      Icons.touch_app,
                                    ),
                                    _buildMiniStat(
                                      'This Week',
                                      profileController.weeklyUsageTime.value,
